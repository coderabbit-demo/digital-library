 ...
 */
import type { LibraryStatus, Preferences } from "@/lib/types";
...
export const seedLibraryEntries: SeedLibraryEntry[] = [
  { userKey: "ava", mediaKey: "left-hand-darkness", status: "finished", rating: 5, review: "Quietly brilliant. The political worldbuilding stayed with me for days.", updatedAt: "2026-05-27T20:35:00.000Z" },
  { userKey: "ava", mediaKey: "project-hail-mary", status: "current", rating: null, review: "", updatedAt: "2026-05-28T02:10:00.000Z" },
  { userKey: "ava", mediaKey: "babel", status: "wishlist", rating: null, review: "", updatedAt: "2026-05-25T16:20:00.000Z" },
];
