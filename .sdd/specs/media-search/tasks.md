...
- [x] 1. Search provider clients and fan-out
...
- [x] 2. Global search results page and app-shell search bar
...
- [x] 3. Scoped search on Library, Wishlist, and Reviews
...
- [x] 4. Full verification and non-regression
