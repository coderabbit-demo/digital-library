...
- [x] 1. Widen trending media types and document the TMDB key
...
- [x] 2. (P) Apple Podcasts trending provider
...
- [x] 3. (P) TMDB trending providers for TV and movies
...
- [x] 4. Register the providers and verify end-to-end
