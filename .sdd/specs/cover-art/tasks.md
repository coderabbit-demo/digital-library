...
- [ ] 1. Persisted cover-artwork data model
- [ ] 1.1 Add cover-artwork storage to media items
...
- [ ] 1.2 Data access for reading and updating artwork
...
- [ ] 2.3 (P) Music, podcast, and TV/movie cover source
...
- [ ] 2.4 Resolve dispatcher by media type
...
- [ ] 3. On-demand cover-resolution endpoint
...
- [ ] 4. Cover rendering on the detail page
- [ ] 4.1 (P) Render artwork in the shared cover component
...
- [ ] 4.2 Wire the detail page and the on-demand trigger
...
- [ ] 5. Capture artwork when adding from Trending
- [ ] 5.1 Carry the trending artwork through the add request
...
- [ ] 5.2 Persist artwork on add without blocking or overwriting
...
- [ ] 6. Backfill covers for seeded and existing items
...
- [ ] 7. Consistency and full verification
