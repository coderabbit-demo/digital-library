...
- [ ] 1. Design-system foundation (Tailwind v4 + shadcn/ui)
- [ ] 1.1 Introduce Tailwind v4 build pipeline and the reference token system
...
- [ ] 1.2 Establish UI primitives, theming, and focus treatment
...
- [ ] 2. Additive database schema and migration
- [ ] 2.1 Extend existing tables for metadata and progress
...
- [ ] 2.2 Add new tables for tags, goals, and achievements
...
- [ ] 3. Domain types and pure computation helpers
- [ ] 3.1 (P) Type-specific media metadata model and labels
...
- [ ] 3.2 (P) Per-user stats aggregation
...
- [ ] 3.3 (P) Reading-goal progress computation
...
- [ ] 3.4 (P) Activity-streak computation
...
- [ ] 3.5 (P) Achievements catalog and evaluator
...
- [ ] 4.5 Media metadata read/write access
...
- [ ] 5.1 Request validators for new write flows
...
- [ ] 5.5 Extend add-media and review flows with types, tags, and unlocks
...
- [ ] 5.6 Preserve existing endpoint contracts
...
- [ ] 6. Seed representative multi-type data
...
- [ ] 7. Restyled app shell and navigation
- [ ] 7.1 Brand bar, primary add action, and horizontal tab navigation
...
- [ ] 7.2 Active-state, responsive shell, and accessible labeling
...
- [ ] 8. Enriched media card and media-type filter
- [ ] 8.1 (P) Media card anatomy
...
- [ ] 8.2 (P) Media-type filter with counts
...
- [ ] 9. Redesigned Home dashboard
- [ ] 9.1 (P) Header and live stat cards
...
- [ ] 10. Section pages, add-item flow, and auth surface
- [ ] 10.1 (P) Library page
...
- [ ] 10.3 (P) Reviews page
  ...
  - _Requirements: 11.3_
- [ ] 10.4 Add-item flow and route reorganization
...
- [ ] 11. Cross-cutting responsiveness and accessibility
- [ ] 11.1 Responsive layout across surfaces
...
- [ ] 11.2 Accessibility conformance
...
- [ ] 12. Integration, isolation, and quality gate
- [ ] 12.1 Integration tests for new data and endpoints
...
- [ ] 12.2 Regression and architecture/quality verification
...
- [ ]* 12.3 UI rendering tests for the redesign
