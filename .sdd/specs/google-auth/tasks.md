...
- [x] 1. Google OIDC client and configuration
- [x] 1.1 Add the configuration gate and document the env vars
...
- [x] 1.2 Build the OIDC client (authorization-code + PKCE)
...
- [x] 2. Profile-picture column and Google user resolution
...
- [x] 3. Start and callback route handlers
...
- [x] 4. Continue-with-Google entry points
...
- [x] 5. Profile picture in the site header
...
- [x] 6. Session parity and full verification
