...
- [ ] 1. Provider abstraction and normalized trending types
...
- [ ] 2. (P) NYT Best Sellers provider (books)
...
- [ ] 3. (P) Spotify New Releases provider (music)
...
- [ ] 5. Add-to-library endpoint and de-duping data access
...
- [ ] 7. Dedicated Trending page and navigation
...
- [ ] 9. (P) Supersede the nyt-recommendations spec
...
- [ ] 10. (P) Configuration, secrets, and local development
...
- [ ] 11. Integration, isolation, and quality gate
...
- [ ]* 12. UI rendering tests for trending surfaces
